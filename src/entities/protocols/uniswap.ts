...
import { Trade as V2Trade, Pair } from '@xlayerswap/v2-sdk'
import { Trade as V3Trade, Pool, encodeRouteToPath } from '@xlayerswap/v3-sdk'
import {
...
import { Currency, TradeType, CurrencyAmount, Percent } from '@xlayerswap/sdk-core'
