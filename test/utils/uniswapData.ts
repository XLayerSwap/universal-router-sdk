...
import { Trade as V2Trade, Pair, Route as RouteV2, computePairAddress } from '@xlayerswap/v2-sdk'
import {
  Trade as V3Trade,
  Pool,
  Route as RouteV3,
...
import { CurrencyAmount, TradeType, Ether, Token, Percent, Currency } from '@xlayerswap/sdk-core'
